...
class ViajesControllerTest < ActionController::TestCase
  ...
  test "should create viaje" do
    assert_difference('Viaje.count') do
      post :create, viaje: { cedula_id: @viaje.cedula_id, distancia: @viaje.distancia, id_auto: @viaje.id_auto, tiempo: @viaje.tiempo, valor: @viaje.valor }
    end
  ...
  test "should update viaje" do
    patch :update, id: @viaje, viaje: { cedula_id: @viaje.cedula_id, distancia: @viaje.distancia, id_auto: @viaje.id_auto, tiempo: @viaje.tiempo, valor: @viaje.valor }
    assert_redirected_to viaje_path(assigns(:viaje))
  end
